  ...
  return (
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        />
        <form
          className="flex flex-grow  px-6 py-3 ml-3 mr-5 border border-gray-200 rounded-full shadow-lg
      max-w-3xl items-center "
        ...
        <Avatar
          className="ml-auto"
          url="https://yt3.ggpht.com/yti/ANoDKi53W6HlfChCPYFWTiaysGDZ1i23AWUdk5TRWy63lg=s88-c-k-c0x00ffffff-no-rj-mo"
        />
      </div>
      <HeaderOptions />
    </header>
